...
function AboutComp() {
    return (
        <div className="relative mt-[150px] w-screen h-screen m-auto flex flex-col-reverse align-start justify-center md:flex-row md:mt-0">
            <div className="relative container p-5 m-auto w-[100%] flex flex-col-reverse space-x-0 md:space-x-20 md:flex-row">
                <div data-aos="fade-left" id="left" className={`relative w-full h-[25rem] bg-pattern bg-cover rounded-tl-[15px] rounded-tr-[15px] overflow-hidden md:w-[50%]`}>
                    <div id="ovl" className='relative bg-flixDark-transparentDark w-full h-full flex flex-col align-center items-center justify-center overflow-hidden rounded-tl-lg rounded-tr-lg border-flixDark-transparentDark'>
                        <img data-aos="fade-up" src={phone} alt="" className="relative mb-[-200px] text-center  w-[300px] rounded" />
                    </div>
                </div>
                <a href="" id='#about'></a>
                <div id="cssc" className="relative w-full h-auto  mb-10 md:mb-0 md:w-[50%]">
                    <div className="top">
                        <span data-aos="fade-up" className="text-sm text-flixWhite-800">About Us</span>
                        <br />
                        <h1 data-aos="fade-up" className="text-[40px] text-flixWhite-200 font-extrabold">Revolutionizing Food Menus</h1>
                        <br />
                        <p data-aos="fade-left" className="font-extralight text-[15px]">
                        ...
                        <br />
                        <a data-aos="zoom-up" href="#waitlist" className='text-[20px] text-flixWhite-200 underline'>Get Early Access</a>
                    </div>
                </div>
            </div>
        </div>
